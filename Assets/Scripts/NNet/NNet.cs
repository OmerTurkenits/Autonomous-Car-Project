...
public class NNet : MonoBehaviour
{
    ...
    /// <summary>
    /// A function that initialises all the networks' layers and parameters.
    /// </summary>
    /// <param name="hiddenLayerCount"> The number of hidden layers </param>
    /// <param name="hiddenNeuronCount"> The number of neurons in each hidden layers </param>
    ...
    /// <summary>
    /// A function that initialises a copy of all the networks' layers and parameters.
    /// </summary>
    /// <param name="hiddenLayerCount"> The number of hidden layers </param>
    /// <param name="hiddenNeuronCount"> The number of neurons in each hidden layers </param>
    /// <returns></returns>
    ...
    /// <summary>
    /// A function that initialises the hidden layers and their parameters.
    /// </summary>
    /// <param name="hiddenLayerCount"> The number of hidden layers </param>
    /// <param name="hiddenNeuronCount">  The number of neurons in each hidden layers </param>
    ...
    /// <summary>
    /// A function that randomises the networks' weights.
    /// </summary>
    ...
    /// <summary>
    /// A function that gets the network input and runs the network.
    /// </summary>
    /// <param name="a"> The first rays' values </param>
    /// <param name="b"> The second rays' values </param>
    /// <param name="c"> The third rays' values </param>
    /// <returns></returns>
    ...
    /// <summary>
    /// A representation of the sigmoid function
    /// </summary>
    /// <param name="s"> The input of the function </param>
    /// <returns></returns>
